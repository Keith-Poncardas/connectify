// ===== Profile Online / Offline Status (Jquery) =====

$(document).ready(function() {
  $('.status').addClass('online'); // Set initial status to online

  // Toggle online/offline status
  $('.profile').click(function() {
    $('.status').toggleClass('online offline');
  });
});

// ===== When you click on any position or link on the screen, the menu will close. =====

// For Bootstrap 5 Navigation Bar Only
